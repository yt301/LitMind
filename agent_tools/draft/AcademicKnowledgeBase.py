...
from langchain_openai import OpenAIEmbeddings  # 替换原来的导入
from langchain.text_splitter import RecursiveCharacterTextSplitter
from pypdf import PdfReader  # 改用纯Python实现的PDF解析器
...
class AcademicKnowledgeBase:
    def __init__(self, knowledge_dir=KNOWLEDGE_BASE_PATH):
        ...
        self.persist_dir = os.path.join(VECTOR_STORE_PATH, "chroma_academic")  # 指定 Chroma 向量数据库的持久化存储目录。
